...
// Class to handle registering and accessing objects by GUID
    public class GuidManager
    {
        ...
        public static bool Add(GUID guidComponent)
        {
            if (Instance == null)
            {
        ...
        public static GameObject ResolveGuid(System.Guid guid, Action<GameObject> onAddCallback,
        ...
        private bool InternalAdd(GUID guidComponent)
        {
        ...
        private GameObject ResolveGuidInternal(System.Guid guid, Action<GameObject> onAddCallback,
                                               Action onRemoveCallback)
        {
            GuidInfo info;
            if (guidToObjectMap.TryGetValue(guid, out info))
